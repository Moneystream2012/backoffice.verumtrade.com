...
@section('main-content')
    <div class="row gutters ">
        <div class="col-md-5">
            <div class="card">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item">@lang('lang.en.unify.personal-office.profile.id'): {{$auth->id}}</li>
                    <li class="list-group-item">@lang('lang.en.unify.personal-office.profile.username'): {{$auth->username}}</li>
                    <li class="list-group-item">@lang('lang.en.unify.personal-office.profile.email'): {{  }}$auth->email}}</li>
                    <li class="list-group-item">@lang('lang.en.unify.personal-office.profile.sponsor'): {{$auth->sponsor()->value('username') ?? '-'}}</li>
                    <li class="list-group-item">@lang('lang.en.unify.personal-office.profile.country'): {{$auth->country_name}}</li>
                    <li class="list-group-item">@lang('lang.en.unify.personal-office.profile.mobile_number'): {{$auth->mobile_number_format}}</li>
                </ul>
            </div>
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header text-center">@lang('lang.en.unify.personal-office.profile.edit')</div>
                @if($auth->verified)
                ...
                <div class="card-body">
                    <form role="form" action="{{route('personal-office.profile.update')}}" method="post"
                        ...
                        <div class="form-group">
                            <label for="inputFirstName" class="control-label">@lang('lang.en.unify.personal-office.profile.first_name')</label>
                        ...
                        <div class="form-group">
                            <label for="inputLastName" class="control-label">@lang('lang.en.unify.personal-office.profile.last_name')</label>
                        ...
                        <div class="form-group">
                            <label for="mobile_number" class="control-label">@lang('lang.en.unify.personal-office.profile.mobile_number')</label>
                        ...
                        <div class="form-group">
                            <label for="country" class="control-label">@lang('lang.en.unify.personal-office.profile.country')</label>
                            <select
                        ...
                        <div class="form-group">
                            <label for="inputAvatar">@lang('lang.en.unify.personal-office.profile.avatar')</label>
                            ...
                            @endif
                            <small class="form-text text-muted">@lang('lang.en.unify.personal-office.profile.allowed_file')
                            </small>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword" class="control-label">@lang('lang.en.unify.personal-office.profile.password')</label>
                        ...
                        <button class="btn btn-block btn-primary" type="submit">@lang('lang.en.unify.personal-office.profile.save')</button>
                    </form>
                </div>
            </div>
        </div>
