...
<a class="btn btn-flat btn-success dropdown-toggle " data-toggle="dropdown">@lang('unify/personal-office/partials/invest/btc.payment') <span class="caret"></span></a>
...
<ul class="dropdown-menu">
    <li>
        <a
            ...
            @lang('unify/personal-office/partials/invest/btc.balance') {{$product->currency}}
        </a>
    </li>
</ul>
