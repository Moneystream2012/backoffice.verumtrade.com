                            ...
                            <li class="chats-{{$item->is_support ? 'right' : 'left'}}">
                                <div class="chats-avatar">
                                    <img
                                        ...
                                        alt="{{$item->full_name}}">
                                    <div class="chats-name">{{ $item->is_support ? trans('unify/personal-office/issues/show.support') : trans('unify/personal-office/issues/show.you')}}</div>
                                </div>
                    ...
                    <form method="post">
                        ...
                        <div class="form-group">
                                <textarea class="form-control {{ $errors->has('body') ? 'is-invalid' : '' }}"
                                          rows="4"
                                          name="body"
                                          placeholder="@lang('unify/personal-office/issues/show.click')"
