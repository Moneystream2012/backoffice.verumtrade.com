    ...
    <div class="panel-heading clearfix">
        ...
        <div class="pull-right">
            <a href="{{ route('personal-office.login') }}">
                <i class="fa fa-lock"></i> @lang('lang.en.unify.personal-office.auth.passwords.reset.sign_in')
            </a>
        </div>
    </div>
    <div class="panel-body">
        ...
        <form novalidate="novalidate" role="form" method="POST" accept-charset="UTF-8"
            ...
            <div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
                <label for="email">@lang('lang.en.unify.personal-office.auth.passwords.reset.email') <span class="text-danger"> *</span></label>
            ...
            <div
                ...
                <label for="password">@lang('lang.en.unify.personal-office.auth.passwords.reset.password') <span class="text-danger"> *</span></label>
                <div class="row">
                    <div class="col-xs-6">
