...
@section('page')
	...
	<div class="panel-heading clearfix">
		<div class="pull-left">
			<i class="fa fa-plus-circle"></i> @lang('lang.en.personal-office.auth.register.title')
		</div>
		<div class="pull-right">
			<a href="{{ route('personal-office.login') }}">
				<i class="fa fa-lock"></i> @lang('lang.en.personal-office.auth.register.sign_in')
			</a>
		</div>
	</div>
	<div class="panel-body">
		<form novalidate="novalidate" role="form" method="POST" accept-charset="UTF-8"
			...
			<div class="form-group {{ $errors->has('first_name') || $errors->has('last_name')  ? ' has-error' : '' }}">
				<label for="first_name">@lang('lang.en.personal-office.auth.register.name') <span class="text-danger"> *</span></label>
				<div class="row">
					<div class="col-xs-6">
			...
			<div class="form-group {{ $errors->has('username') ? ' has-error' : '' }}">
				<label for="username">@lang('lang.en.personal-office.auth.register.username') <span class="text-danger"> *</span></label>
			...
			<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
				<label for="email">@lang('lang.en.personal-office.auth.register.email') <span class="text-danger"> *</span></label>
			...
			<div class="form-group {{ $errors->has('mobile_number') ? ' has-error' : '' }}">
				<label for="mobile_number" class="control-label">@lang('lang.en.personal-office.auth.register.mobile_number')</label>
			...
			<div class="form-group {{ $errors->has('sponsor') ? ' has-error' : '' }}">
				<label for="sponsor">@lang('lang.en.personal-office.auth.register.sponsor') <span class="text-danger"> *</span></label>
			...
			<div class="form-group {{ $errors->has('password') || $errors->has('password_confirmation') ? ' has-error' : '' }}">
				<label for="password">@lang('lang.en.personal-office.auth.register.password') <span class="text-danger"> *</span></label>
				<div class="row">
					<div class="col-xs-6">
			...
			<div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
				<label for="country" class="control-label">@lang('lang.en.personal-office.auth.register.country')</label>
			...
			<div class="panel panel-default hidden">
				<div class="panel-heading">
					...
					@lang('lang.en.personal-office.auth.register.terms')
				</div>
				<div class="panel-body">
			...
			<div class="form-group  {{ $errors->has('terms') ? ' has-error' : '' }}">
				<div class="checkbox">
					<label><input type="checkbox" name="terms"> @lang('lang.en.personal-office.auth.register.agree') <a href="#terms" data-toggle="modal" data-target="#terms">@lang('lang.en.personal-office.auth.register.terms')</a></label>
				</div>
				@if ($errors->has('terms'))
					<span class="help-block">
			...
			<div class="form-group  {{ $errors->has('18_years') ? ' has-error' : '' }}">
				<div class="checkbox">
					<label><input type="checkbox" name="18_years"> @lang('lang.en.personal-office.auth.register.18_years')</label>
				</div>
			...
			<div class="form-group">
				<button type="submit" class="btn btn-block btn-primary">
					<i class="fa fa-save"></i> @lang('lang.en.personal-office.auth.register.create_member')
				</button>
			</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">@lang('lang.en.personal-office.auth.register.close')</button>
                </div>
            </div>
        </div>
    </div>
