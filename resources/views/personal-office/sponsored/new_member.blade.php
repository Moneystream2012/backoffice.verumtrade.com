			...
			<div class="panel panel-default">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
								<label for="inputFirstName" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.first_name')</label>
						...
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
								<label for="inputLastName" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.last_name')</label>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('username') ? ' has-error' : '' }}">
								<label for="username" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.username')</label>
						...
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
								<label for="email" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.email')</label>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('mobile_number') ? ' has-error' : '' }}">
								<label for="mobile_number" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.mobile_number')</label>
						...
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
								<label for="country" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.country')</label>
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
								<label for="password" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.password')</label>
						...
						<div class="col-sm-6">
							...
							<div class="form-group {{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
								<label for="password_confirmation" class="control-label">@lang('lang.en.personal-office.sponsored.new_member.password_confirmation')</label>
				...
				<div class="panel-footer">
					<div class="form-group">
						<button type="submit" class="btn btn-primary">@lang('lang.en.personal-office.sponsored.new_member.submit')</button>
						<a href="{{route('personal-office.sponsored.binary')}}" class="btn btn-white">@lang('lang.en.personal-office.sponsored.new_member.network')</a>
					</div>
				</div>
			</div>
		</form>
