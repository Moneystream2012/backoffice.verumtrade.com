					...
					<div class="row">
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('username') ? ' has-error' : '' }}">
								...
								<input type="text" name="username" class="form-control"  autocomplete="off" id="username" placeholder="@lang('user_name')"
								       value="{{ old('username') }}">
						...
						<div class="col-sm-6">
							<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">
								...
								<input type="email" name="email" class="form-control" id="email"  autocomplete="off" placeholder="@lang('email')"
								       value="{{ old('email') }}">
								@if ($errors->has('email'))
