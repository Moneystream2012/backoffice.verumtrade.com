    ...
    <div class="container-fluid-md">
        ...
        <div class="panel panel-default hidden">
            <div class="panel-heading">
                <p class="panel-title">@lang('lang.en.personal-office.settings.payment_settings')</p>
            </div>
            <div class="panel-body">
                <p class="alert alert-info">@lang('lang.en.personal-office.settings.text')</p>
                <form class="form-horizontal form-bordered" role="form"
                      action="{{route('personal-office.settings.payment.post')}}"
                      method="post">
                    {{ csrf_field() }}
                    <div class="form-group {{ $errors->has('perfectmoney') ? ' has-error' : '' }}">
                        <label for="input_perfectmoney" class="col-sm-4 control-label">@lang('lang.en.personal-office.settings.perfectmoney')</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group {{ $errors->has('advcash') ? ' has-error' : '' }}">
                        <label for="input_advcash" class="col-sm-4 control-label">@lang('lang.en.personal-office.settings.advcash')</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group no-margin-bottom">
                        <div class="col-sm-push-4 col-sm-8">
                            <button type="submit" class="btn btn-primary">@lang('lang.en.personal-office.settings.submit')</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">@lang('lang.en.personal-office.settings.password')</p>
            </div>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" role="form"
                    ...
                    <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                        <label for="password" class="control-label col-sm-4">@lang('lang.en.personal-office.settings.current_password')</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group {{ $errors->has('new_password') ? ' has-error' : '' }}">
                        <label for="new_password" class="control-label col-sm-4">@lang('lang.en.personal-office.settings.new_password')</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group {{ $errors->has('new_password_confirmation') ? ' has-error' : '' }}">
                        <label for="new_password_confirmation" class="control-label col-sm-4">@lang('lang.en.personal-office.settings.confirmation')</label>
                        <div class="col-sm-8">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <p class="panel-title">@lang('lang.en.personal-office.settings.transaction_password')</p>
            </div>
            <div class="panel-body">
                <form class="form-horizontal form-bordered" role="form"
                    ...
                    <div class="form-group {{ $errors->has('transaction_password') ? ' has-error' : '' }}">
                        <label for="transaction_password" class="control-label col-sm-4">@lang('lang.en.personal-office.settings.current_password')</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group {{ $errors->has('new_transaction_password') ? ' has-error' : '' }}">
                        <label for="new_transaction_password" class="control-label col-sm-4">@lang('lang.en.personal-office.settings.new_password')</label>
                        <div class="col-sm-8">
                    ...
                    <div
                        ...
                        <label for="new_transaction_password_confirmation" class="control-label col-sm-4">@lang('lang.en.personal-office.settings.confirmation')</label>
                        <div class="col-sm-8">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label class="control-label col-sm-4">@lang('lang.en.personal-office.settings.languages')</label>
                    <div class="col-sm-8">
