						...
						<form role="form" action="{{route('personal-office/profile.update')}}" method="post"
							...
							<div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
								...
								<input type="text" name="first_name" class="form-control" id="inputFirstName"
								       placeholder="@lang('first_name')" value="{{old('first_name') ?? $auth->first_name}}"  autocomplete="off">
							...
							<div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
								...
								<input type="text" name="last_name" class="form-control" id="inputLastName" placeholder="@lang('last_name')"
							...
							<div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
								...
								<input type="password" name="password" class="form-control" id="inputPassword" placeholder="@lang('pass_word')"  autocomplete="off" required>
