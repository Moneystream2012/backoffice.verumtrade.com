			...
			<div class="col-md-5">
				<div class="panel panel-default panel-profile-details">
					<div class="panel-body">
						...
						<div class="col-sm-7 profile-details">
							...
							<dl class="margin-sm-bottom">
								<dt>@lang('lang.en.personal-office.profile.created_at')</dt>
								<dd>{{$auth->created_at}}</dd>
							</dl>
							<dl class="margin-sm-bottom">
								<dt>@lang('lang.en.personal-office.profile.updated_at')</dt>
								<dd>{{$auth->updated_at ?? '-'}}</dd>
							</dl>
							<dl class="margin-sm-bottom">
								<dt>@lang('lang.en.personal-office.profile.last_login_at')</dt>
					...
					<div class="panel-body">
						<div class="col-xs-6">
							<dl>
								<dt>@lang('lang.en.personal-office.profile.id')</dt>
								<dd>{{$auth->id}}</dd>
							</dl>
							<dl class="margin-sm-bottom">
								<dt>@lang('lang.en.personal-office.profile.username')</dt>
								<dd>{{$auth->username}}</dd>
							</dl>
						</div>
						<div class="col-xs-6">
							<dl>
								<dt>@lang('lang.en.personal-office.profile.email')</dt>
								<dd>{{$auth->email}}</dd>
							</dl>
							<dl class="margin-sm-bottom">
								<dt>@lang('lang.en.personal-office.profile.sponsor')</dt>
			...
			<div class="col-md-7">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">@lang('lang.en.personal-office.profile.user_data')</h4>
					</div>
					<div class="panel-body">
						<form role="form" action="{{route('personal-office.profile.update')}}" method="post"
							...
							<div class="form-group {{ $errors->has('first_name') ? ' has-error' : '' }}">
								<label for="inputFirstName" class="control-label">@lang('lang.en.personal-office.profile.first_name')</label>
							...
							<div class="form-group {{ $errors->has('last_name') ? ' has-error' : '' }}">
								<label for="inputLastName" class="control-label">@lang('lang.en.personal-office.profile.last_name')</label>
							...
							<div class="form-group hidden {{ $errors->has('email') ? ' has-error' : '' }}">
								<label for="email" class="control-label">@lang('lang.en.personal-office.profile.email')</label>
							...
							<div class="form-group {{ $errors->has('mobile_number') ? ' has-error' : '' }}">
								<label for="mobile_number" class="control-label">@lang('lang.en.personal-office.profile.mobile_number')</label>
							...
							<div class="form-group {{ $errors->has('country') ? ' has-error' : '' }}">
								<label for="country" class="control-label">@lang('lang.en.personal-office.profile.country')</label>
							...
							<div class=" hidden form-group{{ $errors->has('avatar') ? ' has-error' : '' }}">
								<label for="inputAvatar" class="control-label">@lang('lang.en.personal-office.profile.avatar')</label>
								<input type="file" class="form-control" name="avatar" id="inputAvatar"
								       accept="image/jpeg,image/png,image/jpg">
								@if ($errors->has('country'))
									<span class="help-block">{{ $errors->first('avatar') }}</span>
								@endif
								<span class="help-block">@lang('lang.en.personal-office.profile.allowed_file')</span>
							</div>

							<div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
								<label for="inputPassword" class="control-label">@lang('lang.en.personal-office.profile.password')</label>
							...
							<button class="btn btn-primary" type="submit">@lang('lang.en.personal-office.profile.update')</button>
						</form>
					</div>
				</div>
			</div>
