		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="margin-md-bottom">
					<a href="{{route('personal-office.issues.new')}}" class="btn btn-primary t">@lang('lang.en.personal-office.issues.index.new_issue')</a>
				</div>

				<div class="panel">
					<div class="panel-heading">
						<strong class="panel-title">@lang('lang.en.personal-office.issues.index.list')</strong>
					</div>
					<div class="table-responsive">
						<table class="table table-hover table-mail">
							...
							@empty
								<td>
									<p class="text-center text-muted margin-vertical">@lang('lang.en.personal-office.issues.index.empty_issues')</p>
								</td>
							@endforelse
							</tbody>
						</table>
