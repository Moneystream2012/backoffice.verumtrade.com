...
@section('page')
	<div class="container-fluid-md">
					...
					<div class="clearfix">
						...
						<div class="pull-left margin-left">
							...
							@if($notification->data['link'] ?? false)
								<a class="margin-sm-bottom" href="{{$notification->data['link']}}">@lang('lang.en.personal-office.notification.look')</a>
							@endif
						</div>
						<div class="pull-right text-right">
							@if($notification->read_at == null)
								<span class="label label-danger ">@lang('lang.en.personal-office.notification.new')</span> <br>
							@endif
		...
		@empty
			<p class="text-center">@lang('lang.en.personal-office.notification.empty_notifications')</p>
		@endforelse
	</div>
@endsection