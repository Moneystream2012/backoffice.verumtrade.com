...
class ValidationServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Validator::extend('sms_verification', function ($attribute, $code, $parameters, $validator) {
            $mobile_number = $validator->getData()[$parameters[0]];
            $smsVerifcation = SmsVerification::where('mobile_number', $mobile_number)->first();

            if ($smsVerifcation && $smsVerifcation->code == (int) $code) {
                return true;
            }
